...
namespace GeneXus.Programs {
   public class gx00a0 : GXDataArea
   {
      ...
      public void execute( out short aP0_pSupplierId )
      {
         this.AV8pSupplierId = 0 ;
         ExecuteImpl();
         aP0_pSupplierId=this.AV8pSupplierId;
      }
      ...
      protected void gxgrGrid1_refresh_invoke( )
      {
         ...
         AV6cSupplierId = (short)(Math.Round(NumberUtil.Val( GetPar( "cSupplierId"), "."), 18, MidpointRounding.ToEven));
         ...
         gxgrGrid1_refresh( subGrid1_Rows, AV6cSupplierId, AV7cSupplierName) ;
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("gx00a0.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV8pSupplierId,4,0))}, new string[] {"pSupplierId"}) +"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "GXH_vCSUPPLIERID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV6cSupplierId), 4, 0, ".", "")));
         GxWebStd.gx_hidden_field( context, "GXH_vCSUPPLIERNAME", StringUtil.RTrim( AV7cSupplierName));
         /* Send saved values. */
      ...
      {
         return formatLink("gx00a0.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV8pSupplierId,4,0))}, new string[] {"pSupplierId"})  ;
      }
      ...
      protected void WB0K0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "start", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblLblsupplieridfilter_Internalname, "Supplier Id", "", "", lblLblsupplieridfilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e110k1_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, 0, 1, "HLP_Gx00A0.htm");
            ...
            GxWebStd.gx_single_line_edit( context, edtavCsupplierid_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV6cSupplierId), 4, 0, ".", "")), StringUtil.LTrim( ((edtavCsupplierid_Enabled!=0) ? context.localUtil.Format( (decimal)(AV6cSupplierId), "ZZZ9") : context.localUtil.Format( (decimal)(AV6cSupplierId), "ZZZ9"))), " dir=\"ltr\" inputmode=\"numeric\" pattern=\"[0-9]*\""+TempTags+" onchange=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onblur(this,16);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavCsupplierid_Jsonclick, 0, "Attribute", "", "", "", "", edtavCsupplierid_Visible, edtavCsupplierid_Enabled, 0, "text", "1", 4, "chr", 1, "row", 4, 0, 0, 0, 0, -1, 0, true, "", "end", false, "", "HLP_Gx00A0.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "start", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, divSuppliernamefiltercontainer_Internalname, 1, 0, "px", 0, "px", divSuppliernamefiltercontainer_Class, "start", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "start", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "start", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblLblsuppliernamefilter_Internalname, "Supplier Name", "", "", lblLblsuppliernamefilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e120k1_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, 0, 1, "HLP_Gx00A0.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "start", "top", "", "", "div");
            ...
            GxWebStd.gx_single_line_edit( context, edtavCsuppliername_Internalname, StringUtil.RTrim( AV7cSupplierName), StringUtil.RTrim( context.localUtil.Format( AV7cSupplierName, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,26);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavCsuppliername_Jsonclick, 0, "Attribute", "", "", "", "", edtavCsuppliername_Visible, edtavCsuppliername_Enabled, 0, "text", "", 50, "chr", 1, "row", 50, 0, 0, 0, 0, -1, -1, true, "", "start", true, "", "HLP_Gx00A0.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtntoggle_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(34), 2, 0)+","+"null"+");", "|||", bttBtntoggle_Jsonclick, 7, "|||", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"e130k1_client"+"'", TempTags, "", 2, "HLP_Gx00A0.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "start", "top", "", "", "div");
         ...
         if ( wbEnd == 34 )
         {
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtn_cancel_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(34), 2, 0)+","+"null"+");", "Cancel", bttBtn_cancel_Jsonclick, 1, "Cancel", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"ECANCEL."+"'", TempTags, "", context.GetButtonType( ), "HLP_Gx00A0.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
      ...
      {
         GxWebStd.gx_hidden_field( context, "gxhash_SUPPLIERID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(A45SupplierId), "ZZZ9"), context));
         GxWebStd.gx_hidden_field( context, "SUPPLIERID", StringUtil.LTrim( StringUtil.NToC( (decimal)(A45SupplierId), 4, 0, ".", "")));
      }
      ...
      protected void RF0K2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            lV7cSupplierName = StringUtil.PadR( StringUtil.RTrim( AV7cSupplierName), 50, "%");
            /* Using cursor H000K2 */
            pr_default.execute(0, new Object[] {AV6cSupplierId, lV7cSupplierName, GXPagingFrom2, GXPagingTo2, GXPagingTo2});
            nGXsfl_34_idx = 1;
            sGXsfl_34_idx = StringUtil.PadL( StringUtil.LTrimStr( (decimal)(nGXsfl_34_idx), 4, 0), 4, "0");
            SubsflControlProps_342( ) ;
            while ( ( (pr_default.getStatus(0) != 101) ) && ( ( GRID1_nCurrentRecord < subGrid1_fnc_Recordsperpage( ) ) ) )
            {
               A46SupplierName = H000K2_A46SupplierName[0];
               A45SupplierId = H000K2_A45SupplierId[0];
               /* Execute user event: Load */
               E150K2 ();
      ...
      {
         GxWebStd.gx_hidden_field( context, "gxhash_SUPPLIERID"+"_"+sGXsfl_34_idx, GetSecureSignedToken( sGXsfl_34_idx, context.localUtil.Format( (decimal)(A45SupplierId), "ZZZ9"), context));
      }
      ...
      protected int subGrid1_fnc_Recordcount( )
      {
         ...
         lV7cSupplierName = StringUtil.PadR( StringUtil.RTrim( AV7cSupplierName), 50, "%");
         /* Using cursor H000K3 */
         pr_default.execute(1, new Object[] {AV6cSupplierId, lV7cSupplierName});
      ...
      protected void STRUP0K0( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            ...
            if ( ( ( context.localUtil.CToN( cgiGet( edtavCsupplierid_Internalname), ".", ",") < Convert.ToDecimal( 0 )) ) || ( ( context.localUtil.CToN( cgiGet( edtavCsupplierid_Internalname), ".", ",") > Convert.ToDecimal( 9999 )) ) )
            {
               ...
               wbErr = true;
               AV6cSupplierId = 0;
               AssignAttri("", false, "AV6cSupplierId", StringUtil.LTrimStr( (decimal)(AV6cSupplierId), 4, 0));
            }
            else
            {
               AV6cSupplierId = (short)(Math.Round(context.localUtil.CToN( cgiGet( edtavCsupplierid_Internalname), ".", ","), 18, MidpointRounding.ToEven));
               AssignAttri("", false, "AV6cSupplierId", StringUtil.LTrimStr( (decimal)(AV6cSupplierId), 4, 0));
            }
      ...
      protected void E160K2( )
      {
         /* Enter Routine */
         returnInSub = false;
         AV8pSupplierId = A45SupplierId;
         AssignAttri("", false, "AV8pSupplierId", StringUtil.LTrimStr( (decimal)(AV8pSupplierId), 4, 0));
         context.setWebReturnParms(new Object[] {(short)AV8pSupplierId});
         context.setWebReturnParmsMetadata(new Object[] {"AV8pSupplierId"});
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202612912424150", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("gx00a0.js", "?202612912424150", false, true);
      ...
      protected void sendrow_342( )
      {
         ...
         if ( ( 10 * 1 == 0 ) || ( nGXsfl_34_idx <= subGrid1_fnc_Recordsperpage( ) * 1 ) )
         {
            ...
            edtavLinkselection_Link = "javascript:gx.popup.gxReturn(["+"'"+GXUtil.EncodeJSConstant( StringUtil.LTrim( StringUtil.NToC( (decimal)(A45SupplierId), 4, 0, ".", "")))+"'"+"]);";
            ...
            edtSupplierName_Link = "javascript:gx.popup.gxReturn(["+"'"+GXUtil.EncodeJSConstant( StringUtil.LTrim( StringUtil.NToC( (decimal)(A45SupplierId), 4, 0, ".", "")))+"'"+"]);";
            AssignProp("", false, edtSupplierName_Internalname, "Link", edtSupplierName_Link, !bGXsfl_34_Refreshing);
            Grid1Row.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtSupplierName_Internalname,StringUtil.RTrim( A46SupplierName),(string)"",(string)"",(string)"'"+""+"'"+",false,"+"'"+""+"'",(string)edtSupplierName_Link,(string)"",(string)"",(string)"",(string)edtSupplierName_Jsonclick,(short)0,(string)"DescriptionAttribute",(string)"",(string)ROClassString,(string)"WWColumn",(string)"",(short)-1,(short)0,(short)0,(string)"text",(string)"",(short)0,(string)"px",(short)17,(string)"px",(short)50,(short)0,(short)0,(short)34,(short)0,(short)-1,(short)-1,(bool)true,(string)"Name",(string)"start",(bool)true,(string)""});
      ...
      protected void StartGridControl34( )
      {
         ...
         else
         {
            ...
            Grid1Container.AddColumnProperties(Grid1Column);
            Grid1Column = GXWebColumn.GetNew(isAjaxCallMode( ));
            Grid1Column.AddObjectProperty("Value", GXUtil.ValueEncode( StringUtil.RTrim( A46SupplierName)));
      ...
      public override void initialize_properties( )
      {
         ...
         divSuppliernamefiltercontainer_Class = "AdvancedContainerItem AdvancedContainerItemExpanded";
         divSupplieridfiltercontainer_Class = "AdvancedContainerItem AdvancedContainerItemExpanded";
      ...
      {
         setEventMetadata("REFRESH","""{"handler":"Refresh","iparms":[{"av":"GRID1_nFirstRecordOnPage"},{"av":"GRID1_nEOF"},{"av":"subGrid1_Rows","ctrl":"GRID1","prop":"Rows"},{"av":"AV6cSupplierId","fld":"vCSUPPLIERID","pic":"ZZZ9"},{"av":"AV7cSupplierName","fld":"vCSUPPLIERNAME"}]}""");
         setEventMetadata("'TOGGLE'","""{"handler":"E130K1","iparms":[{"av":"divAdvancedcontainer_Class","ctrl":"ADVANCEDCONTAINER","prop":"Class"},{"ctrl":"BTNTOGGLE","prop":"Class"}]""");
         setEventMetadata("'TOGGLE'",""","oparms":[{"av":"divAdvancedcontainer_Class","ctrl":"ADVANCEDCONTAINER","prop":"Class"},{"ctrl":"BTNTOGGLE","prop":"Class"}]}""");
         setEventMetadata("LBLSUPPLIERIDFILTER.CLICK","""{"handler":"E110K1","iparms":[{"av":"divSupplieridfiltercontainer_Class","ctrl":"SUPPLIERIDFILTERCONTAINER","prop":"Class"}]""");
         ...
         setEventMetadata("LBLSUPPLIERNAMEFILTER.CLICK","""{"handler":"E120K1","iparms":[{"av":"divSuppliernamefiltercontainer_Class","ctrl":"SUPPLIERNAMEFILTERCONTAINER","prop":"Class"}]""");
         ...
         setEventMetadata("ENTER","""{"handler":"E160K2","iparms":[{"av":"A45SupplierId","fld":"SUPPLIERID","pic":"ZZZ9","hsh":true}]""");
         setEventMetadata("ENTER",""","oparms":[{"av":"AV8pSupplierId","fld":"vPSUPPLIERID","pic":"ZZZ9"}]}""");
         setEventMetadata("GRID1_FIRSTPAGE","""{"handler":"subgrid1_firstpage","iparms":[{"av":"GRID1_nFirstRecordOnPage"},{"av":"GRID1_nEOF"},{"av":"subGrid1_Rows","ctrl":"GRID1","prop":"Rows"},{"av":"AV6cSupplierId","fld":"vCSUPPLIERID","pic":"ZZZ9"},{"av":"AV7cSupplierName","fld":"vCSUPPLIERNAME"}]}""");
         setEventMetadata("GRID1_PREVPAGE","""{"handler":"subgrid1_previouspage","iparms":[{"av":"GRID1_nFirstRecordOnPage"},{"av":"GRID1_nEOF"},{"av":"subGrid1_Rows","ctrl":"GRID1","prop":"Rows"},{"av":"AV6cSupplierId","fld":"vCSUPPLIERID","pic":"ZZZ9"},{"av":"AV7cSupplierName","fld":"vCSUPPLIERNAME"}]}""");
         setEventMetadata("GRID1_NEXTPAGE","""{"handler":"subgrid1_nextpage","iparms":[{"av":"GRID1_nFirstRecordOnPage"},{"av":"GRID1_nEOF"},{"av":"subGrid1_Rows","ctrl":"GRID1","prop":"Rows"},{"av":"AV6cSupplierId","fld":"vCSUPPLIERID","pic":"ZZZ9"},{"av":"AV7cSupplierName","fld":"vCSUPPLIERNAME"}]}""");
         setEventMetadata("GRID1_LASTPAGE","""{"handler":"subgrid1_lastpage","iparms":[{"av":"GRID1_nFirstRecordOnPage"},{"av":"GRID1_nEOF"},{"av":"subGrid1_Rows","ctrl":"GRID1","prop":"Rows"},{"av":"AV6cSupplierId","fld":"vCSUPPLIERID","pic":"ZZZ9"},{"av":"AV7cSupplierName","fld":"vCSUPPLIERNAME"}]}""");
      ...
      public override void initialize( )
      {
         ...
         A46SupplierName = "";
         lV7cSupplierName = "";
         H000K2_A46SupplierName = new string[] {""} ;
         H000K2_A45SupplierId = new short[1] ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.gx00a0__default(),
            new Object[][] {
                new Object[] {
               H000K2_A46SupplierName, H000K2_A45SupplierId
               }
               , new Object[] {
      ...
      private string[] H000K2_A46SupplierName ;
      private short[] H000K2_A45SupplierId ;
      private long[] H000K3_AGRID1_nRecordCount ;
      private msglist BackMsgLst ;
      private msglist LclMsgLst ;
      private short aP0_pSupplierId ;
   }
   ...
   public class gx00a0__default : DataStoreHelperBase, IDataStoreHelper
   {
                                             ...
                                             short AV6cSupplierId )
      {
         ...
         string sFromString;
         string sOrderString;
         sSelectString = " [SupplierName], [SupplierId]";
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("@AV6cSupplierId",GXType.Int16,4,0) ,
          new ParDef("@lV7cSupplierName",GXType.NChar,50,0) ,
