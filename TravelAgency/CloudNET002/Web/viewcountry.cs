...
namespace GeneXus.Programs {
   public class viewcountry : GXDataArea
   {
      ...
      protected void send_integrity_footer_hashes( )
      {
         ...
         forbiddenHiddens.Add("CountryName", StringUtil.RTrim( context.localUtil.Format( A10CountryName, "")));
      ...
      protected void WB090( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblCity_title_Internalname, "City", "", "", lblCity_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, 0, "HLP_ViewCountry.htm");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "Section", "start", "top", "", "display:none;", "div");
            ...
            /* Div Control */
            GxWebStd.gx_div_start( context, divTablecity_Internalname, 1, 0, "px", 0, "px", "ww__view__tab__form-container", "start", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "start", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "start", "top", "", "", "div");
            ...
            {
               /* WebComponent */
               GxWebStd.gx_hidden_field( context, "W0034"+"", StringUtil.RTrim( WebComp_Citywc_Component));
               context.WriteHtmlText( "<div") ;
               GxWebStd.ClassAttribute( context, "gxwebcomponent");
      ...
      protected void RF092( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            {
               A9CountryId = H00092_A9CountryId[0];
               A10CountryName = H00092_A10CountryName[0];
      ...
      protected void E11092( )
      {
         ...
         {
            A9CountryId = H00093_A9CountryId[0];
            A10CountryName = H00093_A10CountryName[0];
            AssignAttri("", false, "A10CountryName", A10CountryName);
            AV14GXLvl7 = 1;
            Form.Caption = A10CountryName;
      ...
      protected void S112( )
      {
         ...
         if ( AV11LoadAllTabs || ( StringUtil.StrCmp(AV7SelectedTabCode, "City") == 0 ) )
         {
            ...
            if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Citywc_Component), StringUtil.Lower( "CountryCityWC")) != 0 )
            {
               WebComp_Citywc = getWebComponent(GetType(), "GeneXus.Programs", "countrycitywc", new Object[] {context} );
               WebComp_Citywc.ComponentInit();
               WebComp_Citywc.Name = "CountryCityWC";
               WebComp_Citywc_Component = "CountryCityWC";
            }
            if ( StringUtil.Len( WebComp_Citywc_Component) != 0 )
            {
               WebComp_Citywc.setjustcreated();
               WebComp_Citywc.componentprepare(new Object[] {(string)"W0034",(string)"",(short)AV12CountryId});
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202622210164349", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("viewcountry.js", "?202622210164349", false, true);
         context.AddJavascriptSource("shared/HistoryManager/HistoryManager.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/rsh/json2005.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/rsh/rsh.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
      ...
      {
         setEventMetadata("REFRESH","""{"handler":"Refresh","iparms":[{"av":"AV12CountryId","fld":"vCOUNTRYID","pic":"ZZZ9","hsh":true},{"av":"AV6TabCode","fld":"vTABCODE","hsh":true},{"av":"A10CountryName","fld":"COUNTRYNAME"}]}""");
         return  ;
      }
      ...
      public override void initialize( )
      {
         ...
         sEvtType = "";
         AV13Pgmname = "";
         H00092_A9CountryId = new short[1] ;
         H00092_A10CountryName = new string[] {""} ;
         hsh = "";
         H00093_A9CountryId = new short[1] ;
         H00093_A10CountryName = new string[] {""} ;
         BackMsgLst = new msglist();
         LclMsgLst = new msglist();
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.viewcountry__default(),
            new Object[][] {
                new Object[] {
               H00092_A9CountryId, H00092_A10CountryName
               }
               , new Object[] {
               H00093_A9CountryId, H00093_A10CountryName
               }
            }
         );
      ...
      private short[] H00092_A9CountryId ;
      private string[] H00092_A10CountryName ;
      private short[] H00093_A9CountryId ;
      private string[] H00093_A10CountryName ;
   ...
   public class viewcountry__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H00092", "SELECT [CountryId], [CountryName] FROM [Country] WHERE [CountryId] = @AV12CountryId ORDER BY [CountryId] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00092,1, GxCacheFrequency.OFF ,true,true )
             ,new CursorDef("H00093", "SELECT [CountryId], [CountryName] FROM [Country] WHERE [CountryId] = @AV12CountryId ORDER BY [CountryId] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00093,1, GxCacheFrequency.OFF ,false,true )
          };
       }
    }
