...
namespace GeneXus.Programs {
   public class category : GXDataArea
   {
      ...
      protected void DrawControls( )
      {
         ...
         GxWebStd.gx_single_line_edit( context, edtCategoryName_Internalname, StringUtil.RTrim( A12CategoryName), StringUtil.RTrim( context.localUtil.Format( A12CategoryName, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,39);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtCategoryName_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtCategoryName_Enabled, 0, "text", "", 50, "chr", 1, "row", 50, 0, 0, 0, 0, -1, -1, true, "Name", "start", true, "", "HLP_Category.htm");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
      ...
      protected void getByPrimaryKey( )
      {
         ...
         if ( (pr_default.getStatus(1) != 101) )
         {
            ...
            n11CategoryId = T00043_n11CategoryId[0];
            AssignAttri("", false, "A11CategoryId", StringUtil.LTrimStr( (decimal)(A11CategoryId), 4, 0));
      ...
      protected void move_next( )
      {
         ...
         if ( (pr_default.getStatus(4) != 101) )
         {
            ...
            if ( (pr_default.getStatus(4) != 101) && ( ( T00046_A11CategoryId[0] > A11CategoryId ) ) )
            {
               ...
               n11CategoryId = T00046_n11CategoryId[0];
               AssignAttri("", false, "A11CategoryId", StringUtil.LTrimStr( (decimal)(A11CategoryId), 4, 0));
               RcdFound4 = 1;
            }
         }
      ...
      protected void move_previous( )
      {
         RcdFound4 = 0;
         /* Using cursor T00047 */
         pr_default.execute(5, new Object[] {n11CategoryId, A11CategoryId});
         if ( (pr_default.getStatus(5) != 101) )
         {
            ...
            if ( (pr_default.getStatus(5) != 101) && ( ( T00047_A11CategoryId[0] < A11CategoryId ) ) )
            {
               ...
               n11CategoryId = T00047_n11CategoryId[0];
               AssignAttri("", false, "A11CategoryId", StringUtil.LTrimStr( (decimal)(A11CategoryId), 4, 0));
               RcdFound4 = 1;
            }
         }
            ...
            if ( AnyError == 0 )
            {
               ...
               if ( AnyError == 0 )
               {
                  ...
                  if ( AnyError == 0 )
                  {
                     ...
                     n11CategoryId = T00048_n11CategoryId[0];
                     AssignAttri("", false, "A11CategoryId", StringUtil.LTrimStr( (decimal)(A11CategoryId), 4, 0));
                     pr_default.close(6);
         ...
         if ( AnyError == 0 )
         {
            ...
            if ( AnyError == 0 )
            {
               ...
               if ( AnyError == 0 )
               {
                  ...
                  {
                     /* Using cursor T00049 */
                     pr_default.execute(7, new Object[] {A12CategoryName, n11CategoryId, A11CategoryId});
                     pr_default.close(7);
                     pr_default.SmartCacheProvider.SetUpdated("Category");
      ...
      public void ScanStart044( )
      {
         ...
         {
            RcdFound4 = 1;
            A11CategoryId = T000412_A11CategoryId[0];
            n11CategoryId = T000412_n11CategoryId[0];
            AssignAttri("", false, "A11CategoryId", StringUtil.LTrimStr( (decimal)(A11CategoryId), 4, 0));
         }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202621620464062", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("category.js", "?202621620464063", false, true);
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("VALID_CATEGORYID",""","oparms":[{"av":"A12CategoryName","fld":"CATEGORYNAME"},{"av":"Gx_mode","fld":"vMODE","pic":"@!"},{"av":"Z11CategoryId"},{"av":"Z12CategoryName"},{"ctrl":"BTN_DELETE","prop":"Enabled"},{"ctrl":"BTN_ENTER","prop":"Enabled"}]}""");
         return  ;
      }
      ...
      public override void initialize( )
      {
         ...
         T00044_n11CategoryId = new bool[] {false} ;
         T00044_A12CategoryName = new string[] {""} ;
         T00045_A11CategoryId = new short[1] ;
         T00045_n11CategoryId = new bool[] {false} ;
         T00043_A11CategoryId = new short[1] ;
         T00043_n11CategoryId = new bool[] {false} ;
         T00043_A12CategoryName = new string[] {""} ;
         sMode4 = "";
         T00046_A11CategoryId = new short[1] ;
         T00046_n11CategoryId = new bool[] {false} ;
         T00047_A11CategoryId = new short[1] ;
         T00047_n11CategoryId = new bool[] {false} ;
         T00042_A11CategoryId = new short[1] ;
         T00042_n11CategoryId = new bool[] {false} ;
         T00042_A12CategoryName = new string[] {""} ;
         T00048_A11CategoryId = new short[1] ;
         T00048_n11CategoryId = new bool[] {false} ;
         T000411_A7AttractionId = new short[1] ;
         T000412_A11CategoryId = new short[1] ;
         T000412_n11CategoryId = new bool[] {false} ;
         sDynURL = "";
         FormProcess = "";
         bodyStyle = "";
         ZZ12CategoryName = "";
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.category__default(),
            new Object[][] {
               ...
               , new Object[] {
               T000411_A7AttractionId
               }
               , new Object[] {
               T000412_A11CategoryId
               }
            }
         );
      }
      ...
      private bool[] T00044_n11CategoryId ;
      private string[] T00044_A12CategoryName ;
      private short[] T00045_A11CategoryId ;
      private bool[] T00045_n11CategoryId ;
      private short[] T00043_A11CategoryId ;
      private bool[] T00043_n11CategoryId ;
      private string[] T00043_A12CategoryName ;
      private short[] T00046_A11CategoryId ;
      private bool[] T00046_n11CategoryId ;
      private short[] T00047_A11CategoryId ;
      private bool[] T00047_n11CategoryId ;
      private short[] T00042_A11CategoryId ;
      private bool[] T00042_n11CategoryId ;
      private string[] T00042_A12CategoryName ;
      private short[] T00048_A11CategoryId ;
      private bool[] T00048_n11CategoryId ;
      private short[] T000411_A7AttractionId ;
      private short[] T000412_A11CategoryId ;
      private bool[] T000412_n11CategoryId ;
   }
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
             ...
             ,new CursorDef("T000411", "SELECT TOP 1 [AttractionId] FROM [Attractions] WHERE [CategoryId] = @CategoryId ",true, GxErrorMask.GX_NOMASK, false, this,prmT000411,1, GxCacheFrequency.OFF ,true,true )
             ,new CursorDef("T000412", "SELECT [CategoryId] FROM [Category] ORDER BY [CategoryId]  OPTION (FAST 100)",true, GxErrorMask.GX_NOMASK, false, this,prmT000412,100, GxCacheFrequency.OFF ,true,false )
          };
       }
    }
