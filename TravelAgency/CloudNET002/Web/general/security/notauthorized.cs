...
namespace GeneXus.Programs.general.security {
   public class notauthorized : GXDataArea
   {
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"\" data-gx-class=\"\" novalidate action=\""+formatLink("general.security.notauthorized.aspx", new object[] {UrlEncode(StringUtil.RTrim(GxObject))}, new string[] {"GxObject"}) +"\">") ;
      ...
      protected void wb_table1_3_082e( bool wbgen )
      {
         if ( wbgen )
         {
            wb_table2_12_082( true) ;
         }
         else
         {
            wb_table2_12_082( false) ;
         }
         return  ;
      }

      protected void wb_table2_12_082e( bool wbgen )
      {
         if ( wbgen )
         {
            wb_table3_15_082( true) ;
         }
         else
         {
            wb_table3_15_082( false) ;
         }
         return  ;
      }

      protected void wb_table3_15_082e( bool wbgen )
      {
         if ( wbgen )
         {
         }
      ...
      protected void wb_table3_15_082( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            wb_table3_15_082e( true) ;
         }
         else
         {
            wb_table3_15_082e( false) ;
         }
      }

      protected void wb_table2_12_082( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table2_12_082e( true) ;
         }
         else
         {
            wb_table2_12_082e( false) ;
         }
      }
      ...
      protected void wb_table1_3_082( bool wbgen )
      {
         if ( wbgen )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTitletext_Internalname, "Not Authorized", "", "", lblTitletext_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "", 0, "", 1, 1, 0, 0, "HLP_General/Security/NotAuthorized.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            context.WriteHtmlText( "<tr>") ;
            context.WriteHtmlText( "<td colspan=\"2\" >") ;
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202622210164279", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("general/security/notauthorized.js", "?202622210164280", false, true);
