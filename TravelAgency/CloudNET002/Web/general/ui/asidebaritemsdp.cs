...
namespace GeneXus.Programs.general.ui {
   public class asidebaritemsdp : GXProcedure
   {
      ...
      {
         return new general.ui.asidebaritemsdp().MainImpl(args); ;
      }
      ...
      {
         GXBaseCollection<GeneXus.Programs.genexusunanimo.SdtSidebarItems_SidebarItem> aP0_Gxm2rootcol = new GXBaseCollection<GeneXus.Programs.genexusunanimo.SdtSidebarItems_SidebarItem>()  ;
      ...
      {
         AV5wwProgramNames = new GXBaseCollection<GeneXus.Programs.general.ui.SdtProgramNames_ProgramName>( context, "ProgramName", "TravelAgency");
         GXt_objcol_SdtProgramNames_ProgramName1 = new GXBaseCollection<GeneXus.Programs.general.ui.SdtProgramNames_ProgramName>( context, "ProgramName", "TravelAgency");
