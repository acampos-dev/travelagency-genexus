   ...
   public class gx0010 : GXDataArea
   {
      ...
      protected void WB030( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "start", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblLblcustomeridfilter_Internalname, "Customer Id", "", "", lblLblcustomeridfilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e11031_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, 0, 1, "HLP_Gx0010.htm");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "start", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblLblcustomernamefilter_Internalname, "Customer Name", "", "", lblLblcustomernamefilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e12031_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, 0, 1, "HLP_Gx0010.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "start", "top", "", "", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "start", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, divCustomerlastnamefiltercontainer_Internalname, 1, 0, "px", 0, "px", divCustomerlastnamefiltercontainer_Class, "start", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "start", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "start", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblLblcustomerlastnamefilter_Internalname, "Customer Last Name", "", "", lblLblcustomerlastnamefilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e13031_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, 0, 1, "HLP_Gx0010.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "start", "top", "", "", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "start", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblLblcustomerphonefilter_Internalname, "Customer Phone", "", "", lblLblcustomerphonefilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e14031_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, 0, 1, "HLP_Gx0010.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "start", "top", "", "", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "start", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblLblcustomeremailfilter_Internalname, "Customer Email", "", "", lblLblcustomeremailfilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e15031_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, 0, 1, "HLP_Gx0010.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "start", "top", "", "", "div");
            ...
            GxWebStd.gx_single_line_edit( context, edtavCcustomeremail_Internalname, AV10cCustomerEmail, StringUtil.RTrim( context.localUtil.Format( AV10cCustomerEmail, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,56);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavCcustomeremail_Jsonclick, 0, "Attribute", "", "", "", "", edtavCcustomeremail_Visible, edtavCcustomeremail_Enabled, 0, "text", "", 80, "chr", 1, "row", 100, 0, 0, 0, 0, -1, 0, true, "", "start", true, "", "HLP_Gx0010.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "start", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, divCustomeraddeddatefiltercontainer_Internalname, 1, 0, "px", 0, "px", "AdvancedContainerItem AdvancedContainerItemExpanded", "start", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "start", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "start", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblLblcustomeraddeddatefilter_Internalname, "Customer Added Date", "", "", lblLblcustomeraddeddatefilter_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "WWAdvancedLabel WWDateFilterLabel", 0, "", 1, 1, 0, 1, "HLP_Gx0010.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "start", "top", "", "", "div");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtntoggle_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(74), 2, 0)+","+"null"+");", "|||", bttBtntoggle_Jsonclick, 7, "|||", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"e16031_client"+"'", TempTags, "", 2, "HLP_Gx0010.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "start", "top", "", "", "div");
                     ...
                     if ( StringUtil.StrCmp(sEvtType, "E") == 0 )
                     {
                        ...
                        else
                        {
                           ...
                           if ( ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "START") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 4), "LOAD") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "ENTER") == 0 ) )
                           {
                              ...
                              A16CustomerAddedDate = DateTimeUtil.ResetTime(context.localUtil.CToT( cgiGet( edtCustomerAddedDate_Internalname), 0));
                              sEvtType = StringUtil.Right( sEvt, 1);
                              if ( StringUtil.StrCmp(sEvtType, ".") == 0 )
                              {
                                 sEvt = StringUtil.Left( sEvt, (short)(StringUtil.Len( sEvt)-1));
      ...
      protected void RF032( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            {
               A6CustomerEmail = H00032_A6CustomerEmail[0];
               A16CustomerAddedDate = H00032_A16CustomerAddedDate[0];
               A5CustomerPhone = H00032_A5CustomerPhone[0];
               A3CustomerLastName = H00032_A3CustomerLastName[0];
               A2CustomerName = H00032_A2CustomerName[0];
               A1CustomerId = H00032_A1CustomerId[0];
               /* Execute user event: Load */
               E18032 ();
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202612519543528", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("gx0010.js", "?202612519543529", false, true);
      ...
      protected void sendrow_742( )
      {
         ...
         if ( ( 10 * 1 == 0 ) || ( nGXsfl_74_idx <= subGrid1_fnc_Recordsperpage( ) * 1 ) )
         {
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            Grid1Row.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtCustomerAddedDate_Internalname,context.localUtil.Format(A16CustomerAddedDate, "99/99/99"),context.localUtil.Format( A16CustomerAddedDate, "99/99/99"),(string)"",(string)"'"+""+"'"+",false,"+"'"+""+"'",(string)"",(string)"",(string)"",(string)"",(string)edtCustomerAddedDate_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"WWColumn OptionalColumn",(string)"",(short)-1,(short)0,(short)0,(string)"text",(string)"",(short)0,(string)"px",(short)17,(string)"px",(short)8,(short)0,(short)0,(short)74,(short)0,(short)-1,(short)0,(bool)true,(string)"",(string)"end",(bool)false,(string)""});
      ...
      protected void StartGridControl74( )
      {
         ...
         else
         {
            ...
            Grid1Container.AddColumnProperties(Grid1Column);
            Grid1Column = GXWebColumn.GetNew(isAjaxCallMode( ));
            Grid1Column.AddObjectProperty("Value", GXUtil.ValueEncode( StringUtil.RTrim( A2CustomerName)));
            Grid1Column.AddObjectProperty("Link", StringUtil.RTrim( edtCustomerName_Link));
            Grid1Container.AddColumnProperties(Grid1Column);
            Grid1Column = GXWebColumn.GetNew(isAjaxCallMode( ));
            Grid1Column.AddObjectProperty("Value", GXUtil.ValueEncode( StringUtil.RTrim( A3CustomerLastName)));
            Grid1Container.AddColumnProperties(Grid1Column);
            Grid1Column = GXWebColumn.GetNew(isAjaxCallMode( ));
            Grid1Column.AddObjectProperty("Value", GXUtil.ValueEncode( StringUtil.RTrim( A5CustomerPhone)));
            Grid1Container.AddColumnProperties(Grid1Column);
            Grid1Column = GXWebColumn.GetNew(isAjaxCallMode( ));
            Grid1Column.AddObjectProperty("Value", GXUtil.ValueEncode( context.localUtil.Format(A16CustomerAddedDate, "99/99/99")));
            Grid1Container.AddColumnProperties(Grid1Column);
      ...
      public override void initialize_properties( )
      {
         ...
         divCustomerlastnamefiltercontainer_Class = "AdvancedContainerItem AdvancedContainerItemExpanded";
      ...
      {
         setEventMetadata("REFRESH","""{"handler":"Refresh","iparms":[{"av":"GRID1_nFirstRecordOnPage"},{"av":"GRID1_nEOF"},{"av":"subGrid1_Rows","ctrl":"GRID1","prop":"Rows"},{"av":"AV6cCustomerId","fld":"vCCUSTOMERID","pic":"ZZZ9"},{"av":"AV7cCustomerName","fld":"vCCUSTOMERNAME"},{"av":"AV8cCustomerLastName","fld":"vCCUSTOMERLASTNAME"},{"av":"AV9cCustomerPhone","fld":"vCCUSTOMERPHONE"},{"av":"AV10cCustomerEmail","fld":"vCCUSTOMEREMAIL"},{"av":"AV13cCustomerAddedDate","fld":"vCCUSTOMERADDEDDATE"}]}""");
         setEventMetadata("'TOGGLE'","""{"handler":"E16031","iparms":[{"av":"divAdvancedcontainer_Class","ctrl":"ADVANCEDCONTAINER","prop":"Class"},{"ctrl":"BTNTOGGLE","prop":"Class"}]""");
         setEventMetadata("'TOGGLE'",""","oparms":[{"av":"divAdvancedcontainer_Class","ctrl":"ADVANCEDCONTAINER","prop":"Class"},{"ctrl":"BTNTOGGLE","prop":"Class"}]}""");
         setEventMetadata("LBLCUSTOMERIDFILTER.CLICK","""{"handler":"E11031","iparms":[{"av":"divCustomeridfiltercontainer_Class","ctrl":"CUSTOMERIDFILTERCONTAINER","prop":"Class"}]""");
         ...
         setEventMetadata("LBLCUSTOMERNAMEFILTER.CLICK","""{"handler":"E12031","iparms":[{"av":"divCustomernamefiltercontainer_Class","ctrl":"CUSTOMERNAMEFILTERCONTAINER","prop":"Class"}]""");
         ...
         setEventMetadata("LBLCUSTOMERLASTNAMEFILTER.CLICK","""{"handler":"E13031","iparms":[{"av":"divCustomerlastnamefiltercontainer_Class","ctrl":"CUSTOMERLASTNAMEFILTERCONTAINER","prop":"Class"}]""");
         ...
         setEventMetadata("LBLCUSTOMERPHONEFILTER.CLICK","""{"handler":"E14031","iparms":[{"av":"divCustomerphonefiltercontainer_Class","ctrl":"CUSTOMERPHONEFILTERCONTAINER","prop":"Class"}]""");
         ...
         setEventMetadata("LBLCUSTOMEREMAILFILTER.CLICK","""{"handler":"E15031","iparms":[{"av":"divCustomeremailfiltercontainer_Class","ctrl":"CUSTOMEREMAILFILTERCONTAINER","prop":"Class"}]""");
         ...
         setEventMetadata("ENTER","""{"handler":"E19032","iparms":[{"av":"A1CustomerId","fld":"CUSTOMERID","pic":"ZZZ9","hsh":true}]""");
      ...
      public override void initialize( )
      {
         ...
         lV10cCustomerEmail = "";
         A6CustomerEmail = "";
         H00032_A6CustomerEmail = new string[] {""} ;
         H00032_A16CustomerAddedDate = new DateTime[] {DateTime.MinValue} ;
         H00032_A5CustomerPhone = new string[] {""} ;
         H00032_A3CustomerLastName = new string[] {""} ;
         H00032_A2CustomerName = new string[] {""} ;
         H00032_A1CustomerId = new short[1] ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.gx0010__default(),
            new Object[][] {
                new Object[] {
               H00032_A6CustomerEmail, H00032_A16CustomerAddedDate, H00032_A5CustomerPhone, H00032_A3CustomerLastName, H00032_A2CustomerName, H00032_A1CustomerId
               }
               , new Object[] {
      ...
      private string[] H00032_A6CustomerEmail ;
      private DateTime[] H00032_A16CustomerAddedDate ;
      private string[] H00032_A5CustomerPhone ;
      private string[] H00032_A3CustomerLastName ;
      private string[] H00032_A2CustomerName ;
      private short[] H00032_A1CustomerId ;
