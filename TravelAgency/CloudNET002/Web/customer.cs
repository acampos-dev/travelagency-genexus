...
namespace GeneXus.Programs {
   public class customer : GXDataArea
   {
      ...
      protected void DrawControls( )
      {
         ...
         GxWebStd.gx_single_line_edit( context, edtCustomerName_Internalname, StringUtil.RTrim( A2CustomerName), StringUtil.RTrim( context.localUtil.Format( A2CustomerName, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,39);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtCustomerName_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtCustomerName_Enabled, 0, "text", "", 20, "chr", 1, "row", 20, 0, 0, 0, 0, -1, -1, true, "", "start", true, "", "HLP_Customer.htm");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         ...
         GxWebStd.gx_single_line_edit( context, edtCustomerLastName_Internalname, StringUtil.RTrim( A3CustomerLastName), StringUtil.RTrim( context.localUtil.Format( A3CustomerLastName, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,44);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtCustomerLastName_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtCustomerLastName_Enabled, 0, "text", "", 20, "chr", 1, "row", 20, 0, 0, 0, 0, -1, -1, true, "", "start", true, "", "HLP_Customer.htm");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
      ...
      protected void CheckExtendedTable011( )
      {
         ...
         {
            GX_msglist.addItem("Enter the customer name", 1, "CUSTOMERNAME");
            AnyError = 1;
         ...
         {
            GX_msglist.addItem("Enter the customer last name", 1, "CUSTOMERLASTNAME");
            AnyError = 1;
         ...
         if ( AnyError == 0 )
         {
            ...
            if ( AnyError == 0 )
            {
               ...
               if ( AnyError == 0 )
               {
                  ...
                  {
                     /* Using cursor T00018 */
                     pr_default.execute(6, new Object[] {A1CustomerId, A2CustomerName, A3CustomerLastName, A4CustomerAddress, A5CustomerPhone, A6CustomerEmail, A16CustomerAddedDate});
                     pr_default.close(6);
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "Z2CustomerName", StringUtil.RTrim( Z2CustomerName));
         GxWebStd.gx_hidden_field( context, "Z3CustomerLastName", StringUtil.RTrim( Z3CustomerLastName));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202612520101728", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("customer.js", "?202612520101728", false, true);
      ...
      public void Valid_Customerid( )
      {
         ...
         AssignAttri("", false, "A2CustomerName", StringUtil.RTrim( A2CustomerName));
         AssignAttri("", false, "A3CustomerLastName", StringUtil.RTrim( A3CustomerLastName));
         AssignAttri("", false, "A4CustomerAddress", A4CustomerAddress);
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("REFRESH","""{"handler":"Refresh","iparms":[{"av":"A16CustomerAddedDate","fld":"CUSTOMERADDEDDATE"}]}""");
         setEventMetadata("VALID_CUSTOMERID","""{"handler":"Valid_Customerid","iparms":[{"av":"A1CustomerId","fld":"CUSTOMERID","pic":"ZZZ9"},{"av":"Gx_date","fld":"vTODAY"},{"av":"Gx_BScreen","fld":"vGXBSCREEN","pic":"9"},{"av":"Gx_mode","fld":"vMODE","pic":"@!"},{"av":"A16CustomerAddedDate","fld":"CUSTOMERADDEDDATE"}]""");
         setEventMetadata("VALID_CUSTOMERID",""","oparms":[{"av":"A2CustomerName","fld":"CUSTOMERNAME"},{"av":"A3CustomerLastName","fld":"CUSTOMERLASTNAME"},{"av":"A4CustomerAddress","fld":"CUSTOMERADDRESS"},{"av":"A5CustomerPhone","fld":"CUSTOMERPHONE"},{"av":"A6CustomerEmail","fld":"CUSTOMEREMAIL"},{"av":"A16CustomerAddedDate","fld":"CUSTOMERADDEDDATE"},{"av":"Gx_mode","fld":"vMODE","pic":"@!"},{"av":"Z1CustomerId"},{"av":"Z2CustomerName"},{"av":"Z3CustomerLastName"},{"av":"Z4CustomerAddress"},{"av":"Z5CustomerPhone"},{"av":"Z6CustomerEmail"},{"av":"Z16CustomerAddedDate"},{"ctrl":"BTN_DELETE","prop":"Enabled"},{"ctrl":"BTN_ENTER","prop":"Enabled"}]}""");
   ...
   public class customer__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("@CustomerLastName",GXType.NChar,20,0) ,
          ...
          def= new CursorDef[] {
             ...
             ,new CursorDef("T00018", "INSERT INTO [Customer]([CustomerId], [CustomerName], [CustomerLastName], [CustomerAddress], [CustomerPhone], [CustomerEmail], [CustomerAddedDate]) VALUES(@CustomerId, @CustomerName, @CustomerLastName, @CustomerAddress, @CustomerPhone, @CustomerEmail, @CustomerAddedDate)", GxErrorMask.GX_NOMASK,prmT00018)
