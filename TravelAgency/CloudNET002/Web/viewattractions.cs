...
namespace GeneXus.Programs {
   public class viewattractions : GXDataArea
   {
      ...
      public viewattractions( IGxContext context )
      {
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("viewattractions.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV12AttractionId,4,0)),UrlEncode(StringUtil.RTrim(AV6TabCode))}, new string[] {"AttractionId","TabCode"}) +"\">") ;
      ...
      {
         return formatLink("viewattractions.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV12AttractionId,4,0)),UrlEncode(StringUtil.RTrim(AV6TabCode))}, new string[] {"AttractionId","TabCode"})  ;
      }
      ...
      protected void WB0D0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblViewall_Internalname, "Attractions", lblViewall_Link, "", lblViewall_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "ww__view__button-back", 0, "", lblViewall_Visible, 1, 0, 0, "HLP_ViewAttractions.htm");
            ...
            GxWebStd.gx_single_line_edit( context, edtAttractionName_Internalname, StringUtil.RTrim( A8AttractionName), StringUtil.RTrim( context.localUtil.Format( A8AttractionName, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,15);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtAttractionName_Jsonclick, 0, "heading-01", "", "", "", "", 1, edtAttractionName_Enabled, 0, "text", "", 50, "chr", 1, "row", 50, 0, 0, 0, 0, -1, -1, true, "Name", "start", true, "", "HLP_ViewAttractions.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblGeneral_title_Internalname, "General", "", "", lblGeneral_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, 0, "HLP_ViewAttractions.htm");
            /* Div Control */
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblAttraction_title_Internalname, "Supplier", "", "", lblAttraction_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, 0, "HLP_ViewAttractions.htm");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "Section", "start", "top", "", "display:none;", "div");
      ...
      protected void START0D2( )
      {
         ...
         Form.Meta.addItem("description", "View Attractions", 0) ;
         context.wjLoc = "";
      ...
      protected void E110D2( )
      {
         ...
         while ( (pr_default.getStatus(1) != 101) )
         {
            ...
            lblViewall_Link = formatLink("wwattractions.aspx") ;
      ...
      protected void S112( )
      {
         ...
         if ( AV11LoadAllTabs || ( StringUtil.StrCmp(AV7SelectedTabCode, "") == 0 ) || ( StringUtil.StrCmp(AV7SelectedTabCode, "General") == 0 ) )
         {
            ...
            if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Generalwc_Component), StringUtil.Lower( "AttractionsGeneral")) != 0 )
            {
               WebComp_Generalwc = getWebComponent(GetType(), "GeneXus.Programs", "attractionsgeneral", new Object[] {context} );
               WebComp_Generalwc.ComponentInit();
               WebComp_Generalwc.Name = "AttractionsGeneral";
         ...
         if ( AV11LoadAllTabs || ( StringUtil.StrCmp(AV7SelectedTabCode, "Attraction") == 0 ) )
         {
            ...
            if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Attractionwc_Component), StringUtil.Lower( "AttractionsAttractionWC")) != 0 )
            {
               WebComp_Attractionwc = getWebComponent(GetType(), "GeneXus.Programs", "attractionsattractionwc", new Object[] {context} );
               WebComp_Attractionwc.ComponentInit();
               WebComp_Attractionwc.Name = "AttractionsAttractionWC";
               WebComp_Attractionwc_Component = "AttractionsAttractionWC";
            }
            if ( StringUtil.Len( WebComp_Attractionwc_Component) != 0 )
            {
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202613112525242", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("viewattractions.js", "?202613112525242", false, true);
         context.AddJavascriptSource("shared/HistoryManager/HistoryManager.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/rsh/json2005.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/rsh/rsh.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
      ...
      public override void initialize( )
      {
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.viewattractions__default(),
            new Object[][] {
                new Object[] {
   ...
   public class viewattractions__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H000D2", "SELECT [AttractionId], [AttractionName] FROM [Attractions] WHERE [AttractionId] = @AV12AttractionId ORDER BY [AttractionId] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000D2,1, GxCacheFrequency.OFF ,true,true )
             ,new CursorDef("H000D3", "SELECT [AttractionId], [AttractionName] FROM [Attractions] WHERE [AttractionId] = @AV12AttractionId ORDER BY [AttractionId] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000D3,1, GxCacheFrequency.OFF ,false,true )
          };
       }
    }
