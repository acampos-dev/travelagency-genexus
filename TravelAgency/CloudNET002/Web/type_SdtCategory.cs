...
namespace GeneXus.Programs {
   ...
   [XmlType(TypeName =  "Category" , Namespace = "TravelAgency" )]
   [Serializable]
   public class SdtCategory : GxSilentTrnSdt
   {
      ...
      public void Load( short AV11CategoryId )
      {
         IGxSilentTrn obj;
         obj = getTransaction();
         obj.LoadKey(new Object[] {(short)AV11CategoryId});
         return  ;
      }
      ...
      public override void Copy( GxUserType source )
      {
         ...
         gxTv_SdtCategory_Categoryid_N = sdt.gxTv_SdtCategory_Categoryid_N ;
         return  ;
      }
      ...
      public void gxTv_SdtCategory_Categoryid_N_SetNull( )
      {
         gxTv_SdtCategory_Categoryid_N = 0;
         SetDirty("Categoryid_N");
         return  ;
      }

      public bool gxTv_SdtCategory_Categoryid_N_IsNull( )
      {
         return false ;
      }
      ...
      private short gxTv_SdtCategory_Categoryid_N ;
   ...
   [DataContract(Name = @"Category", Namespace = "TravelAgency")]
