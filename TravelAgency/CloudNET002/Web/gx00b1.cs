...
namespace GeneXus.Programs {
   public class gx00b1 : GXDataArea
   {
      ...
      public void execute( short aP0_pSupplierId ,
                           out short aP1_pAttractionId )
      {
         this.AV8pSupplierId = aP0_pSupplierId;
         this.AV9pAttractionId = 0 ;
         ExecuteImpl();
         aP1_pAttractionId=this.AV9pAttractionId;
      }
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            {
               AV8pSupplierId = (short)(Math.Round(NumberUtil.Val( gxfirstwebparm, "."), 18, MidpointRounding.ToEven));
               AssignAttri("", false, "AV8pSupplierId", StringUtil.LTrimStr( (decimal)(AV8pSupplierId), 4, 0));
               if ( StringUtil.StrCmp(gxfirstwebparm, "viewer") != 0 )
               {
                  AV9pAttractionId = (short)(Math.Round(NumberUtil.Val( GetPar( "pAttractionId"), "."), 18, MidpointRounding.ToEven));
                  AssignAttri("", false, "AV9pAttractionId", StringUtil.LTrimStr( (decimal)(AV9pAttractionId), 4, 0));
               }
            }
            if ( toggleJsOutput )
            {
      ...
      protected void gxgrGrid1_refresh_invoke( )
      {
         ...
         AV7cSupplierAttractionDate = context.localUtil.ParseDateParm( GetPar( "cSupplierAttractionDate"));
         AV8pSupplierId = (short)(Math.Round(NumberUtil.Val( GetPar( "pSupplierId"), "."), 18, MidpointRounding.ToEven));
         setAjaxCallMode();
         if ( ! IsValidAjaxCall( true) )
         {
            GxWebError = 1;
         ...
         gxgrGrid1_refresh( subGrid1_Rows, AV6cAttractionId, AV7cSupplierAttractionDate, AV8pSupplierId) ;
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("gx00b1.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV8pSupplierId,4,0)),UrlEncode(StringUtil.LTrimStr(AV9pAttractionId,4,0))}, new string[] {"pSupplierId","pAttractionId"}) +"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "GXH_vCSUPPLIERATTRACTIONDATE", context.localUtil.Format(AV7cSupplierAttractionDate, "99/99/99"));
         /* Send saved values. */
         send_integrity_footer_hashes( ) ;
         GxWebStd.gx_hidden_field( context, "nRC_GXsfl_34", StringUtil.LTrim( StringUtil.NToC( (decimal)(nRC_GXsfl_34), 8, 0, ".", "")));
         GxWebStd.gx_hidden_field( context, "vPSUPPLIERID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV8pSupplierId), 4, 0, ".", "")));
         GxWebStd.gx_hidden_field( context, "vPATTRACTIONID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV9pAttractionId), 4, 0, ".", "")));
      ...
      {
         return formatLink("gx00b1.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV8pSupplierId,4,0)),UrlEncode(StringUtil.LTrimStr(AV9pAttractionId,4,0))}, new string[] {"pSupplierId","pAttractionId"})  ;
      }
      ...
      protected void WB0M0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "start", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblLblattractionidfilter_Internalname, "Attraction Id", "", "", lblLblattractionidfilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e110m1_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, 0, 1, "HLP_Gx00B1.htm");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "start", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, divSupplierattractiondatefiltercontainer_Internalname, 1, 0, "px", 0, "px", "AdvancedContainerItem AdvancedContainerItemExpanded", "start", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "start", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "start", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblLblsupplierattractiondatefilter_Internalname, "Supplier Attraction Date", "", "", lblLblsupplierattractiondatefilter_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "WWAdvancedLabel WWDateFilterLabel", 0, "", 1, 1, 0, 1, "HLP_Gx00B1.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "start", "top", "", "", "div");
            ...
            GxWebStd.gx_single_line_edit( context, edtavCsupplierattractiondate_Internalname, context.localUtil.Format(AV7cSupplierAttractionDate, "99/99/99"), context.localUtil.Format( AV7cSupplierAttractionDate, "99/99/99"), TempTags+" onchange=\""+"gx.date.valid_date(this, 8,'MDY',0,12,'eng',false,0);"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.date.valid_date(this, 8,'MDY',0,12,'eng',false,0);"+";gx.evt.onblur(this,26);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavCsupplierattractiondate_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtavCsupplierattractiondate_Enabled, 0, "text", "", 8, "chr", 1, "row", 8, 0, 0, 0, 0, -1, 0, true, "", "end", false, "", "HLP_Gx00B1.htm");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtntoggle_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(34), 2, 0)+","+"null"+");", "|||", bttBtntoggle_Jsonclick, 7, "|||", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"e120m1_client"+"'", TempTags, "", 2, "HLP_Gx00B1.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "start", "top", "", "", "div");
         ...
         if ( wbEnd == 34 )
         {
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtn_cancel_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(34), 2, 0)+","+"null"+");", "Cancel", bttBtn_cancel_Jsonclick, 1, "Cancel", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"ECANCEL."+"'", TempTags, "", context.GetButtonType( ), "HLP_Gx00B1.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
                     ...
                     if ( StringUtil.StrCmp(sEvtType, "E") == 0 )
                     {
                        ...
                        else
                        {
                           ...
                           if ( ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "START") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 4), "LOAD") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "ENTER") == 0 ) )
                           {
                              ...
                              AssignProp("", false, edtavLinkselection_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( AV5LinkSelection)) ? AV11Linkselection_GXI : context.convertURL( context.PathToRelativeUrl( AV5LinkSelection))), !bGXsfl_34_Refreshing);
                              ...
                              A48SupplierAttractionDate = DateTimeUtil.ResetTime(context.localUtil.CToT( cgiGet( edtSupplierAttractionDate_Internalname), 0));
                              ...
                              if ( StringUtil.StrCmp(sEvtType, ".") == 0 )
                              {
                                 ...
                                 else if ( StringUtil.StrCmp(sEvt, "ENTER") == 0 )
                                 {
                                    ...
                                    if ( ! wbErr )
                                    {
                                       ...
                                       if ( context.localUtil.CToT( cgiGet( "GXH_vCSUPPLIERATTRACTIONDATE"), 0) != AV7cSupplierAttractionDate )
                                       {
                                          Rfr0gs = true;
                                       }
                                       if ( ! Rfr0gs )
      ...
      protected void gxgrGrid1_refresh( int subGrid1_Rows ,
                                        ...
                                        DateTime AV7cSupplierAttractionDate ,
                                        short AV8pSupplierId )
      {
         initialize_formulas( ) ;
         GxWebStd.set_html_headers( context, 0, "", "");
      ...
      protected void RF0M2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            pr_default.dynParam(0, new Object[]{ new Object[]{
                                                 AV7cSupplierAttractionDate ,
                                                 A48SupplierAttractionDate ,
                                                 AV8pSupplierId ,
                                                 AV6cAttractionId ,
                                                 A45SupplierId } ,
                                                 new int[]{
                                                 TypeConstants.DATE, TypeConstants.DATE, TypeConstants.SHORT, TypeConstants.SHORT, TypeConstants.SHORT
                                                 }
            });
            /* Using cursor H000M2 */
            pr_default.execute(0, new Object[] {AV8pSupplierId, AV6cAttractionId, AV7cSupplierAttractionDate, GXPagingFrom2, GXPagingTo2, GXPagingTo2});
            nGXsfl_34_idx = 1;
            sGXsfl_34_idx = StringUtil.PadL( StringUtil.LTrimStr( (decimal)(nGXsfl_34_idx), 4, 0), 4, "0");
            SubsflControlProps_342( ) ;
            while ( ( (pr_default.getStatus(0) != 101) ) && ( ( GRID1_nCurrentRecord < subGrid1_fnc_Recordsperpage( ) ) ) )
            {
               A45SupplierId = H000M2_A45SupplierId[0];
               A48SupplierAttractionDate = H000M2_A48SupplierAttractionDate[0];
               A7AttractionId = H000M2_A7AttractionId[0];
               /* Execute user event: Load */
               E140M2 ();
      ...
      {
         GxWebStd.gx_hidden_field( context, "gxhash_ATTRACTIONID"+"_"+sGXsfl_34_idx, GetSecureSignedToken( sGXsfl_34_idx, context.localUtil.Format( (decimal)(A7AttractionId), "ZZZ9"), context));
      }
      ...
      protected int subGrid1_fnc_Recordcount( )
      {
         ...
         /* Using cursor H000M3 */
         pr_default.execute(1, new Object[] {AV8pSupplierId, AV6cAttractionId, AV7cSupplierAttractionDate});
      ...
      protected void STRUP0M0( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            ...
            if ( context.localUtil.VCDate( cgiGet( edtavCsupplierattractiondate_Internalname), 1) == 0 )
            {
               ...
               AssignAttri("", false, "GX_FocusControl", GX_FocusControl);
               wbErr = true;
               AV7cSupplierAttractionDate = DateTime.MinValue;
               AssignAttri("", false, "AV7cSupplierAttractionDate", context.localUtil.Format(AV7cSupplierAttractionDate, "99/99/99"));
            }
            else
            {
               AV7cSupplierAttractionDate = context.localUtil.CToD( cgiGet( edtavCsupplierattractiondate_Internalname), 1);
               AssignAttri("", false, "AV7cSupplierAttractionDate", context.localUtil.Format(AV7cSupplierAttractionDate, "99/99/99"));
            }
            ...
            if ( DateTimeUtil.ResetTime ( context.localUtil.CToD( cgiGet( "GXH_vCSUPPLIERATTRACTIONDATE"), 1) ) != DateTimeUtil.ResetTime ( AV7cSupplierAttractionDate ) )
            {
               GRID1_nFirstRecordOnPage = 0;
            }
         }
      ...
      protected void E150M2( )
      {
         /* Enter Routine */
         returnInSub = false;
         AV9pAttractionId = A7AttractionId;
         AssignAttri("", false, "AV9pAttractionId", StringUtil.LTrimStr( (decimal)(AV9pAttractionId), 4, 0));
         context.setWebReturnParms(new Object[] {(short)AV9pAttractionId});
         context.setWebReturnParmsMetadata(new Object[] {"AV9pAttractionId"});
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV8pSupplierId = Convert.ToInt16(getParm(obj,0));
         AssignAttri("", false, "AV8pSupplierId", StringUtil.LTrimStr( (decimal)(AV8pSupplierId), 4, 0));
         AV9pAttractionId = Convert.ToInt16(getParm(obj,1));
         AssignAttri("", false, "AV9pAttractionId", StringUtil.LTrimStr( (decimal)(AV9pAttractionId), 4, 0));
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202613112525519", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("gx00b1.js", "?202613112525519", false, true);
      ...
      protected void SubsflControlProps_342( )
      {
         ...
         edtAttractionId_Internalname = "ATTRACTIONID_"+sGXsfl_34_idx;
         edtSupplierAttractionDate_Internalname = "SUPPLIERATTRACTIONDATE_"+sGXsfl_34_idx;
         edtSupplierId_Internalname = "SUPPLIERID_"+sGXsfl_34_idx;
      }

      protected void SubsflControlProps_fel_342( )
      {
         edtavLinkselection_Internalname = "vLINKSELECTION_"+sGXsfl_34_fel_idx;
         edtAttractionId_Internalname = "ATTRACTIONID_"+sGXsfl_34_fel_idx;
         edtSupplierAttractionDate_Internalname = "SUPPLIERATTRACTIONDATE_"+sGXsfl_34_fel_idx;
         edtSupplierId_Internalname = "SUPPLIERID_"+sGXsfl_34_fel_idx;
      }
      ...
      protected void sendrow_342( )
      {
         ...
         if ( ( 10 * 1 == 0 ) || ( nGXsfl_34_idx <= subGrid1_fnc_Recordsperpage( ) * 1 ) )
         {
            ...
            edtSupplierAttractionDate_Link = "javascript:gx.popup.gxReturn(["+"'"+GXUtil.EncodeJSConstant( StringUtil.LTrim( StringUtil.NToC( (decimal)(A7AttractionId), 4, 0, ".", "")))+"'"+"]);";
            AssignProp("", false, edtSupplierAttractionDate_Internalname, "Link", edtSupplierAttractionDate_Link, !bGXsfl_34_Refreshing);
            Grid1Row.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtSupplierAttractionDate_Internalname,context.localUtil.Format(A48SupplierAttractionDate, "99/99/99"),context.localUtil.Format( A48SupplierAttractionDate, "99/99/99"),(string)"",(string)"'"+""+"'"+",false,"+"'"+""+"'",(string)edtSupplierAttractionDate_Link,(string)"",(string)"",(string)"",(string)edtSupplierAttractionDate_Jsonclick,(short)0,(string)"DescriptionAttribute",(string)"",(string)ROClassString,(string)"WWColumn",(string)"",(short)-1,(short)0,(short)0,(string)"text",(string)"",(short)0,(string)"px",(short)17,(string)"px",(short)8,(short)0,(short)0,(short)34,(short)0,(short)-1,(short)0,(bool)true,(string)"",(string)"end",(bool)false,(string)""});
            /* Subfile cell */
            if ( Grid1Container.GetWrapped() == 1 )
            {
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            Grid1Row.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtSupplierId_Internalname,StringUtil.LTrim( StringUtil.NToC( (decimal)(A45SupplierId), 4, 0, ".", "")),StringUtil.LTrim( context.localUtil.Format( (decimal)(A45SupplierId), "ZZZ9")),(string)" dir=\"ltr\" inputmode=\"numeric\" pattern=\"[0-9]*\""+"",(string)"'"+""+"'"+",false,"+"'"+""+"'",(string)"",(string)"",(string)"",(string)"",(string)edtSupplierId_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"",(string)"",(short)0,(short)0,(short)0,(string)"text",(string)"1",(short)0,(string)"px",(short)17,(string)"px",(short)4,(short)0,(short)0,(short)34,(short)0,(short)-1,(short)0,(bool)true,(string)"Id",(string)"end",(bool)false,(string)""});
      ...
      protected void StartGridControl34( )
      {
         if ( Grid1Container.GetWrapped() == 1 )
         {
            ...
            context.SendWebValue( "Attraction Date") ;
            context.WriteHtmlTextNl( "</th>") ;
         ...
         else
         {
            ...
            Grid1Container.AddColumnProperties(Grid1Column);
            Grid1Column = GXWebColumn.GetNew(isAjaxCallMode( ));
            Grid1Column.AddObjectProperty("Value", GXUtil.ValueEncode( context.localUtil.Format(A48SupplierAttractionDate, "99/99/99")));
            Grid1Column.AddObjectProperty("Link", StringUtil.RTrim( edtSupplierAttractionDate_Link));
            Grid1Container.AddColumnProperties(Grid1Column);
            Grid1Column = GXWebColumn.GetNew(isAjaxCallMode( ));
            Grid1Column.AddObjectProperty("Value", GXUtil.ValueEncode( StringUtil.LTrim( StringUtil.NToC( (decimal)(A45SupplierId), 4, 0, ".", ""))));
            Grid1Container.AddColumnProperties(Grid1Column);
      ...
      public override void initialize_properties( )
      {
         ...
         edtSupplierAttractionDate_Link = "";
         ...
         divAttractionidfiltercontainer_Class = "AdvancedContainerItem AdvancedContainerItemExpanded";
      ...
      {
         setEventMetadata("REFRESH","""{"handler":"Refresh","iparms":[{"av":"GRID1_nFirstRecordOnPage"},{"av":"GRID1_nEOF"},{"av":"subGrid1_Rows","ctrl":"GRID1","prop":"Rows"},{"av":"AV6cAttractionId","fld":"vCATTRACTIONID","pic":"ZZZ9"},{"av":"AV7cSupplierAttractionDate","fld":"vCSUPPLIERATTRACTIONDATE"},{"av":"AV8pSupplierId","fld":"vPSUPPLIERID","pic":"ZZZ9"}]}""");
         ...
         setEventMetadata("LBLATTRACTIONIDFILTER.CLICK","""{"handler":"E110M1","iparms":[{"av":"divAttractionidfiltercontainer_Class","ctrl":"ATTRACTIONIDFILTERCONTAINER","prop":"Class"}]""");
         ...
         setEventMetadata("ENTER","""{"handler":"E150M2","iparms":[{"av":"A7AttractionId","fld":"ATTRACTIONID","pic":"ZZZ9","hsh":true}]""");
         setEventMetadata("ENTER",""","oparms":[{"av":"AV9pAttractionId","fld":"vPATTRACTIONID","pic":"ZZZ9"}]}""");
         setEventMetadata("GRID1_FIRSTPAGE","""{"handler":"subgrid1_firstpage","iparms":[{"av":"GRID1_nFirstRecordOnPage"},{"av":"GRID1_nEOF"},{"av":"subGrid1_Rows","ctrl":"GRID1","prop":"Rows"},{"av":"AV6cAttractionId","fld":"vCATTRACTIONID","pic":"ZZZ9"},{"av":"AV7cSupplierAttractionDate","fld":"vCSUPPLIERATTRACTIONDATE"},{"av":"AV8pSupplierId","fld":"vPSUPPLIERID","pic":"ZZZ9"}]}""");
         setEventMetadata("GRID1_PREVPAGE","""{"handler":"subgrid1_previouspage","iparms":[{"av":"GRID1_nFirstRecordOnPage"},{"av":"GRID1_nEOF"},{"av":"subGrid1_Rows","ctrl":"GRID1","prop":"Rows"},{"av":"AV6cAttractionId","fld":"vCATTRACTIONID","pic":"ZZZ9"},{"av":"AV7cSupplierAttractionDate","fld":"vCSUPPLIERATTRACTIONDATE"},{"av":"AV8pSupplierId","fld":"vPSUPPLIERID","pic":"ZZZ9"}]}""");
         setEventMetadata("GRID1_NEXTPAGE","""{"handler":"subgrid1_nextpage","iparms":[{"av":"GRID1_nFirstRecordOnPage"},{"av":"GRID1_nEOF"},{"av":"subGrid1_Rows","ctrl":"GRID1","prop":"Rows"},{"av":"AV6cAttractionId","fld":"vCATTRACTIONID","pic":"ZZZ9"},{"av":"AV7cSupplierAttractionDate","fld":"vCSUPPLIERATTRACTIONDATE"},{"av":"AV8pSupplierId","fld":"vPSUPPLIERID","pic":"ZZZ9"}]}""");
         setEventMetadata("GRID1_LASTPAGE","""{"handler":"subgrid1_lastpage","iparms":[{"av":"GRID1_nFirstRecordOnPage"},{"av":"GRID1_nEOF"},{"av":"subGrid1_Rows","ctrl":"GRID1","prop":"Rows"},{"av":"AV6cAttractionId","fld":"vCATTRACTIONID","pic":"ZZZ9"},{"av":"AV7cSupplierAttractionDate","fld":"vCSUPPLIERATTRACTIONDATE"},{"av":"AV8pSupplierId","fld":"vPSUPPLIERID","pic":"ZZZ9"}]}""");
      ...
      public override void initialize( )
      {
         ...
         H000M2_A45SupplierId = new short[1] ;
         H000M2_A48SupplierAttractionDate = new DateTime[] {DateTime.MinValue} ;
         H000M2_A7AttractionId = new short[1] ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.gx00b1__default(),
            new Object[][] {
                new Object[] {
               H000M2_A45SupplierId, H000M2_A48SupplierAttractionDate, H000M2_A7AttractionId
               }
               , new Object[] {
      ...
      private short AV8pSupplierId ;
      private short AV9pAttractionId ;
      private short wcpOAV8pSupplierId ;
      ...
      private short[] H000M2_A45SupplierId ;
      private DateTime[] H000M2_A48SupplierAttractionDate ;
      private short[] H000M2_A7AttractionId ;
      private long[] H000M3_AGRID1_nRecordCount ;
      private msglist BackMsgLst ;
      private msglist LclMsgLst ;
      private short aP1_pAttractionId ;
   }
   ...
   public class gx00b1__default : DataStoreHelperBase, IDataStoreHelper
   {
      protected Object[] conditional_H000M2( IGxContext context ,
                                             DateTime AV7cSupplierAttractionDate ,
                                             DateTime A48SupplierAttractionDate ,
                                             short AV8pSupplierId ,
                                             short AV6cAttractionId ,
                                             short A45SupplierId )
      {
         ...
         string sFromString;
         string sOrderString;
         sSelectString = " [SupplierId], [SupplierAttractionDate], [AttractionId]";
         sFromString = " FROM [SupplierAttraction]";
         sOrderString = "";
         AddWhere(sWhereString, "([SupplierId] = @AV8pSupplierId and [AttractionId] >= @AV6cAttractionId)");
         if ( ! (DateTime.MinValue==AV7cSupplierAttractionDate) )
         {
            AddWhere(sWhereString, "([SupplierAttractionDate] >= @AV7cSupplierAttractionDate)");
         }
         else
         {
            GXv_int1[2] = 1;
         }
         sOrderString += " ORDER BY [SupplierId], [AttractionId]";
                                             ...
                                             short A45SupplierId )
      {
         ...
         scmdbuf = "SELECT COUNT(*) FROM [SupplierAttraction]";
         AddWhere(sWhereString, "([SupplierId] = @AV8pSupplierId and [AttractionId] >= @AV6cAttractionId)");
         if ( ! (DateTime.MinValue==AV7cSupplierAttractionDate) )
         {
            AddWhere(sWhereString, "([SupplierAttractionDate] >= @AV7cSupplierAttractionDate)");
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_H000M2(context, (DateTime)dynConstraints[0] , (DateTime)dynConstraints[1] , (short)dynConstraints[2] , (short)dynConstraints[3] , (short)dynConstraints[4] );
               case 1 :
                     return conditional_H000M3(context, (DateTime)dynConstraints[0] , (DateTime)dynConstraints[1] , (short)dynConstraints[2] , (short)dynConstraints[3] , (short)dynConstraints[4] );
         }
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("@AV8pSupplierId",GXType.Int16,4,0) ,
          new ParDef("@AV6cAttractionId",GXType.Int16,4,0) ,
          new ParDef("@AV7cSupplierAttractionDate",GXType.Date,8,0) ,
