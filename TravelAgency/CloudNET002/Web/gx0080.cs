...
namespace GeneXus.Programs {
   public class gx0080 : GXDataArea
   {
      ...
      public void execute( out short aP0_pAirlineId )
      {
         this.AV9pAirlineId = 0 ;
         ExecuteImpl();
         aP0_pAirlineId=this.AV9pAirlineId;
      }
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            gxfirstwebparm = GetFirstPar( "pAirlineId");
            ...
            {
               AV9pAirlineId = (short)(Math.Round(NumberUtil.Val( gxfirstwebparm, "."), 18, MidpointRounding.ToEven));
               AssignAttri("", false, "AV9pAirlineId", StringUtil.LTrimStr( (decimal)(AV9pAirlineId), 4, 0));
            }
            if ( toggleJsOutput )
            {
               if ( context.isSpaRequest( ) )
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("gx0080.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV9pAirlineId,4,0))}, new string[] {"pAirlineId"}) +"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "GXH_vCAIRLINENAME", StringUtil.RTrim( AV7cAirlineName));
         GxWebStd.gx_hidden_field( context, "GXH_vCAIRLINEDISCOUNTPERCENTAGE", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV8cAirlineDiscountPercentage), 3, 0, ".", "")));
         /* Send saved values. */
      ...
      {
         return formatLink("gx0080.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV9pAirlineId,4,0))}, new string[] {"pAirlineId"})  ;
      }
      ...
      protected void WB0I0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "start", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblLblairlineidfilter_Internalname, "Airline Id", "", "", lblLblairlineidfilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e110i1_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, 0, 1, "HLP_Gx0080.htm");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "start", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, divAirlinenamefiltercontainer_Internalname, 1, 0, "px", 0, "px", divAirlinenamefiltercontainer_Class, "start", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "start", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "start", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblLblairlinenamefilter_Internalname, "Airline Name", "", "", lblLblairlinenamefilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e120i1_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, 0, 1, "HLP_Gx0080.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "start", "top", "", "", "div");
            ...
            GxWebStd.gx_single_line_edit( context, edtavCairlinename_Internalname, StringUtil.RTrim( AV7cAirlineName), StringUtil.RTrim( context.localUtil.Format( AV7cAirlineName, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,26);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavCairlinename_Jsonclick, 0, "Attribute", "", "", "", "", edtavCairlinename_Visible, edtavCairlinename_Enabled, 0, "text", "", 50, "chr", 1, "row", 50, 0, 0, 0, 0, -1, -1, true, "", "start", true, "", "HLP_Gx0080.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "start", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, divAirlinediscountpercentagefiltercontainer_Internalname, 1, 0, "px", 0, "px", divAirlinediscountpercentagefiltercontainer_Class, "start", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "start", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "start", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblLblairlinediscountpercentagefilter_Internalname, "Airline Discount Percentage", "", "", lblLblairlinediscountpercentagefilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e130i1_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, 0, 1, "HLP_Gx0080.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "start", "top", "", "", "div");
            ...
            GxWebStd.gx_single_line_edit( context, edtavCairlinediscountpercentage_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV8cAirlineDiscountPercentage), 3, 0, ".", "")), StringUtil.LTrim( ((edtavCairlinediscountpercentage_Enabled!=0) ? context.localUtil.Format( (decimal)(AV8cAirlineDiscountPercentage), "ZZ9") : context.localUtil.Format( (decimal)(AV8cAirlineDiscountPercentage), "ZZ9"))), " dir=\"ltr\" inputmode=\"numeric\" pattern=\"[0-9]*\""+TempTags+" onchange=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onblur(this,36);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavCairlinediscountpercentage_Jsonclick, 0, "Attribute", "", "", "", "", edtavCairlinediscountpercentage_Visible, edtavCairlinediscountpercentage_Enabled, 0, "text", "1", 3, "chr", 1, "row", 3, 0, 0, 0, 0, -1, 0, true, "", "end", false, "", "HLP_Gx0080.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtntoggle_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(44), 2, 0)+","+"null"+");", "|||", bttBtntoggle_Jsonclick, 7, "|||", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"e140i1_client"+"'", TempTags, "", 2, "HLP_Gx0080.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "start", "top", "", "", "div");
      ...
      protected void START0I2( )
      {
         ...
         Form.Meta.addItem("description", "Selection List Airline", 0) ;
         context.wjLoc = "";
                              ...
                              if ( StringUtil.StrCmp(sEvtType, ".") == 0 )
                              {
                                 ...
                                 else if ( StringUtil.StrCmp(sEvt, "ENTER") == 0 )
                                 {
                                    ...
                                    if ( ! wbErr )
                                    {
                                       ...
                                       if ( ( context.localUtil.CToN( cgiGet( "GXH_vCAIRLINEID"), ".", ",") != Convert.ToDecimal( AV6cAirlineId )) )
                                       {
                                          Rfr0gs = true;
                                       }
                                       /* Set Refresh If Cairlinename Changed */
                                       if ( StringUtil.StrCmp(cgiGet( "GXH_vCAIRLINENAME"), AV7cAirlineName) != 0 )
                                       {
                                          Rfr0gs = true;
                                       }
                                       /* Set Refresh If Cairlinediscountpercentage Changed */
                                       if ( ( context.localUtil.CToN( cgiGet( "GXH_vCAIRLINEDISCOUNTPERCENTAGE"), ".", ",") != Convert.ToDecimal( AV8cAirlineDiscountPercentage )) )
                                       {
                                          Rfr0gs = true;
                                       }
                                       if ( ! Rfr0gs )
      ...
      {
         GxWebStd.gx_hidden_field( context, "gxhash_AIRLINEID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(A36AirlineId), "ZZZ9"), context));
         GxWebStd.gx_hidden_field( context, "AIRLINEID", StringUtil.LTrim( StringUtil.NToC( (decimal)(A36AirlineId), 4, 0, ".", "")));
      }
      ...
      protected void RF0I2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            pr_default.dynParam(0, new Object[]{ new Object[]{
                                                 ...
                                                 A37AirlineName ,
                                                 A38AirlineDiscountPercentage ,
                                                 AV6cAirlineId } ,
                                                 new int[]{
                                                 TypeConstants.SHORT, TypeConstants.SHORT, TypeConstants.SHORT
                                                 }
            });
            lV7cAirlineName = StringUtil.PadR( StringUtil.RTrim( AV7cAirlineName), 50, "%");
            /* Using cursor H000I2 */
            ...
            {
               A38AirlineDiscountPercentage = H000I2_A38AirlineDiscountPercentage[0];
               A37AirlineName = H000I2_A37AirlineName[0];
               A36AirlineId = H000I2_A36AirlineId[0];
               /* Execute user event: Load */
               E160I2 ();
      ...
      {
         GxWebStd.gx_hidden_field( context, "gxhash_AIRLINEID"+"_"+sGXsfl_44_idx, GetSecureSignedToken( sGXsfl_44_idx, context.localUtil.Format( (decimal)(A36AirlineId), "ZZZ9"), context));
      }
      ...
      protected void STRUP0I0( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            ...
            if ( ( ( context.localUtil.CToN( cgiGet( edtavCairlineid_Internalname), ".", ",") < Convert.ToDecimal( 0 )) ) || ( ( context.localUtil.CToN( cgiGet( edtavCairlineid_Internalname), ".", ",") > Convert.ToDecimal( 9999 )) ) )
            {
               ...
               wbErr = true;
               AV6cAirlineId = 0;
               AssignAttri("", false, "AV6cAirlineId", StringUtil.LTrimStr( (decimal)(AV6cAirlineId), 4, 0));
            }
            else
            {
               AV6cAirlineId = (short)(Math.Round(context.localUtil.CToN( cgiGet( edtavCairlineid_Internalname), ".", ","), 18, MidpointRounding.ToEven));
               AssignAttri("", false, "AV6cAirlineId", StringUtil.LTrimStr( (decimal)(AV6cAirlineId), 4, 0));
            }
            AV7cAirlineName = cgiGet( edtavCairlinename_Internalname);
            AssignAttri("", false, "AV7cAirlineName", AV7cAirlineName);
            if ( ( ( context.localUtil.CToN( cgiGet( edtavCairlinediscountpercentage_Internalname), ".", ",") < Convert.ToDecimal( 0 )) ) || ( ( context.localUtil.CToN( cgiGet( edtavCairlinediscountpercentage_Internalname), ".", ",") > Convert.ToDecimal( 999 )) ) )
            {
               GX_msglist.addItem(context.GetMessage( "GXM_badnum", ""), 1, "vCAIRLINEDISCOUNTPERCENTAGE");
               GX_FocusControl = edtavCairlinediscountpercentage_Internalname;
               AssignAttri("", false, "GX_FocusControl", GX_FocusControl);
               wbErr = true;
               AV8cAirlineDiscountPercentage = 0;
               AssignAttri("", false, "AV8cAirlineDiscountPercentage", StringUtil.LTrimStr( (decimal)(AV8cAirlineDiscountPercentage), 3, 0));
            }
            else
            {
      ...
      protected void E150I2( )
      {
         /* Start Routine */
         returnInSub = false;
         Form.Caption = StringUtil.Format( "Selection List %1", "Airline", "", "", "", "", "", "", "", "");
      ...
      protected void E170I2( )
      {
         /* Enter Routine */
         returnInSub = false;
         AV9pAirlineId = A36AirlineId;
         AssignAttri("", false, "AV9pAirlineId", StringUtil.LTrimStr( (decimal)(AV9pAirlineId), 4, 0));
         context.setWebReturnParms(new Object[] {(short)AV9pAirlineId});
         context.setWebReturnParmsMetadata(new Object[] {"AV9pAirlineId"});
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV9pAirlineId = Convert.ToInt16(getParm(obj,0));
         AssignAttri("", false, "AV9pAirlineId", StringUtil.LTrimStr( (decimal)(AV9pAirlineId), 4, 0));
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202622210165613", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("gx0080.js", "?202622210165613", false, true);
      ...
      protected void sendrow_442( )
      {
         ...
         if ( ( 10 * 1 == 0 ) || ( nGXsfl_44_idx <= subGrid1_fnc_Recordsperpage( ) * 1 ) )
         {
            ...
            edtavLinkselection_Link = "javascript:gx.popup.gxReturn(["+"'"+GXUtil.EncodeJSConstant( StringUtil.LTrim( StringUtil.NToC( (decimal)(A36AirlineId), 4, 0, ".", "")))+"'"+"]);";
            ...
            edtAirlineName_Link = "javascript:gx.popup.gxReturn(["+"'"+GXUtil.EncodeJSConstant( StringUtil.LTrim( StringUtil.NToC( (decimal)(A36AirlineId), 4, 0, ".", "")))+"'"+"]);";
            AssignProp("", false, edtAirlineName_Internalname, "Link", edtAirlineName_Link, !bGXsfl_44_Refreshing);
            Grid1Row.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtAirlineName_Internalname,StringUtil.RTrim( A37AirlineName),(string)"",(string)"",(string)"'"+""+"'"+",false,"+"'"+""+"'",(string)edtAirlineName_Link,(string)"",(string)"",(string)"",(string)edtAirlineName_Jsonclick,(short)0,(string)"DescriptionAttribute",(string)"",(string)ROClassString,(string)"WWColumn",(string)"",(short)-1,(short)0,(short)0,(string)"text",(string)"",(short)0,(string)"px",(short)17,(string)"px",(short)50,(short)0,(short)0,(short)44,(short)0,(short)-1,(short)-1,(bool)true,(string)"Name",(string)"start",(bool)true,(string)""});
            /* Subfile cell */
            if ( Grid1Container.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"end"+"\""+" style=\""+""+"\">") ;
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            Grid1Row.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtAirlineDiscountPercentage_Internalname,StringUtil.LTrim( StringUtil.NToC( (decimal)(A38AirlineDiscountPercentage), 3, 0, ".", "")),StringUtil.LTrim( context.localUtil.Format( (decimal)(A38AirlineDiscountPercentage), "ZZ9")),(string)" dir=\"ltr\" inputmode=\"numeric\" pattern=\"[0-9]*\""+"",(string)"'"+""+"'"+",false,"+"'"+""+"'",(string)"",(string)"",(string)"",(string)"",(string)edtAirlineDiscountPercentage_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"WWColumn OptionalColumn",(string)"",(short)-1,(short)0,(short)0,(string)"text",(string)"1",(short)0,(string)"px",(short)17,(string)"px",(short)3,(short)0,(short)0,(short)44,(short)0,(short)-1,(short)0,(bool)true,(string)"Percentage",(string)"end",(bool)false,(string)""});
      ...
      protected void StartGridControl44( )
      {
         ...
         else
         {
            ...
            Grid1Container.AddColumnProperties(Grid1Column);
            Grid1Column = GXWebColumn.GetNew(isAjaxCallMode( ));
            Grid1Column.AddObjectProperty("Value", GXUtil.ValueEncode( StringUtil.RTrim( A37AirlineName)));
            Grid1Column.AddObjectProperty("Link", StringUtil.RTrim( edtAirlineName_Link));
            Grid1Container.AddColumnProperties(Grid1Column);
            Grid1Column = GXWebColumn.GetNew(isAjaxCallMode( ));
            Grid1Column.AddObjectProperty("Value", GXUtil.ValueEncode( StringUtil.LTrim( StringUtil.NToC( (decimal)(A38AirlineDiscountPercentage), 3, 0, ".", ""))));
            Grid1Container.AddColumnProperties(Grid1Column);
      ...
      protected void init_default_properties( )
      {
         ...
         lblLblairlinenamefilter_Internalname = "LBLAIRLINENAMEFILTER";
         edtavCairlinename_Internalname = "vCAIRLINENAME";
         divAirlinenamefiltercontainer_Internalname = "AIRLINENAMEFILTERCONTAINER";
      ...
      public override void initialize_properties( )
      {
         ...
         edtavCairlinename_Jsonclick = "";
         edtavCairlinename_Enabled = 1;
         edtavCairlinename_Visible = 1;
         edtavCairlineid_Jsonclick = "";
         edtavCairlineid_Enabled = 1;
         edtavCairlineid_Visible = 1;
         divAirlinediscountpercentagefiltercontainer_Class = "AdvancedContainerItem AdvancedContainerItemExpanded";
         divAirlinenamefiltercontainer_Class = "AdvancedContainerItem AdvancedContainerItemExpanded";
         ...
         Form.Caption = "Selection List Airline";
         subGrid1_Rows = 10;
         if ( context.isSpaRequest( ) )
         {
            enableJsOutput();
      ...
      {
         setEventMetadata("REFRESH","""{"handler":"Refresh","iparms":[{"av":"GRID1_nFirstRecordOnPage"},{"av":"GRID1_nEOF"},{"av":"subGrid1_Rows","ctrl":"GRID1","prop":"Rows"},{"av":"AV6cAirlineId","fld":"vCAIRLINEID","pic":"ZZZ9"},{"av":"AV7cAirlineName","fld":"vCAIRLINENAME"},{"av":"AV8cAirlineDiscountPercentage","fld":"vCAIRLINEDISCOUNTPERCENTAGE","pic":"ZZ9"}]}""");
         setEventMetadata("'TOGGLE'","""{"handler":"E140I1","iparms":[{"av":"divAdvancedcontainer_Class","ctrl":"ADVANCEDCONTAINER","prop":"Class"},{"ctrl":"BTNTOGGLE","prop":"Class"}]""");
         setEventMetadata("'TOGGLE'",""","oparms":[{"av":"divAdvancedcontainer_Class","ctrl":"ADVANCEDCONTAINER","prop":"Class"},{"ctrl":"BTNTOGGLE","prop":"Class"}]}""");
         setEventMetadata("LBLAIRLINEIDFILTER.CLICK","""{"handler":"E110I1","iparms":[{"av":"divAirlineidfiltercontainer_Class","ctrl":"AIRLINEIDFILTERCONTAINER","prop":"Class"}]""");
         ...
         setEventMetadata("LBLAIRLINENAMEFILTER.CLICK","""{"handler":"E120I1","iparms":[{"av":"divAirlinenamefiltercontainer_Class","ctrl":"AIRLINENAMEFILTERCONTAINER","prop":"Class"}]""");
         ...
         setEventMetadata("LBLAIRLINEDISCOUNTPERCENTAGEFILTER.CLICK","""{"handler":"E130I1","iparms":[{"av":"divAirlinediscountpercentagefiltercontainer_Class","ctrl":"AIRLINEDISCOUNTPERCENTAGEFILTERCONTAINER","prop":"Class"}]""");
         ...
         setEventMetadata("ENTER","""{"handler":"E170I2","iparms":[{"av":"A36AirlineId","fld":"AIRLINEID","pic":"ZZZ9","hsh":true}]""");
         setEventMetadata("ENTER",""","oparms":[{"av":"AV9pAirlineId","fld":"vPAIRLINEID","pic":"ZZZ9"}]}""");
         setEventMetadata("GRID1_FIRSTPAGE","""{"handler":"subgrid1_firstpage","iparms":[{"av":"GRID1_nFirstRecordOnPage"},{"av":"GRID1_nEOF"},{"av":"subGrid1_Rows","ctrl":"GRID1","prop":"Rows"},{"av":"AV6cAirlineId","fld":"vCAIRLINEID","pic":"ZZZ9"},{"av":"AV7cAirlineName","fld":"vCAIRLINENAME"},{"av":"AV8cAirlineDiscountPercentage","fld":"vCAIRLINEDISCOUNTPERCENTAGE","pic":"ZZ9"}]}""");
         setEventMetadata("GRID1_PREVPAGE","""{"handler":"subgrid1_previouspage","iparms":[{"av":"GRID1_nFirstRecordOnPage"},{"av":"GRID1_nEOF"},{"av":"subGrid1_Rows","ctrl":"GRID1","prop":"Rows"},{"av":"AV6cAirlineId","fld":"vCAIRLINEID","pic":"ZZZ9"},{"av":"AV7cAirlineName","fld":"vCAIRLINENAME"},{"av":"AV8cAirlineDiscountPercentage","fld":"vCAIRLINEDISCOUNTPERCENTAGE","pic":"ZZ9"}]}""");
         setEventMetadata("GRID1_NEXTPAGE","""{"handler":"subgrid1_nextpage","iparms":[{"av":"GRID1_nFirstRecordOnPage"},{"av":"GRID1_nEOF"},{"av":"subGrid1_Rows","ctrl":"GRID1","prop":"Rows"},{"av":"AV6cAirlineId","fld":"vCAIRLINEID","pic":"ZZZ9"},{"av":"AV7cAirlineName","fld":"vCAIRLINENAME"},{"av":"AV8cAirlineDiscountPercentage","fld":"vCAIRLINEDISCOUNTPERCENTAGE","pic":"ZZ9"}]}""");
         setEventMetadata("GRID1_LASTPAGE","""{"handler":"subgrid1_lastpage","iparms":[{"av":"GRID1_nFirstRecordOnPage"},{"av":"GRID1_nEOF"},{"av":"subGrid1_Rows","ctrl":"GRID1","prop":"Rows"},{"av":"AV6cAirlineId","fld":"vCAIRLINEID","pic":"ZZZ9"},{"av":"AV7cAirlineName","fld":"vCAIRLINENAME"},{"av":"AV8cAirlineDiscountPercentage","fld":"vCAIRLINEDISCOUNTPERCENTAGE","pic":"ZZ9"}]}""");
      ...
      public override void initialize( )
      {
         ...
         A37AirlineName = "";
         lV7cAirlineName = "";
         H000I2_A38AirlineDiscountPercentage = new short[1] ;
         H000I2_A37AirlineName = new string[] {""} ;
         H000I2_A36AirlineId = new short[1] ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.gx0080__default(),
            new Object[][] {
                new Object[] {
               H000I2_A38AirlineDiscountPercentage, H000I2_A37AirlineName, H000I2_A36AirlineId
               }
               , new Object[] {
      ...
      private string divAirlinenamefiltercontainer_Internalname ;
      private string lblLblairlinenamefilter_Internalname ;
      private string lblLblairlinenamefilter_Jsonclick ;
      private string edtavCairlinename_Internalname ;
      private string edtavCairlinename_Jsonclick ;
      private string divAirlinediscountpercentagefiltercontainer_Internalname ;
      private string lblLblairlinediscountpercentagefilter_Internalname ;
      ...
      private short[] H000I2_A38AirlineDiscountPercentage ;
      private string[] H000I2_A37AirlineName ;
      private short[] H000I2_A36AirlineId ;
      private long[] H000I3_AGRID1_nRecordCount ;
      private msglist BackMsgLst ;
      private msglist LclMsgLst ;
      private short aP0_pAirlineId ;
   }
   ...
   public class gx0080__default : DataStoreHelperBase, IDataStoreHelper
   {
      protected Object[] conditional_H000I2( IGxContext context ,
                                             string AV7cAirlineName ,
                                             short AV8cAirlineDiscountPercentage ,
                                             string A37AirlineName ,
                                             short A38AirlineDiscountPercentage ,
                                             short AV6cAirlineId )
      {
         ...
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV7cAirlineName)) )
         {
            AddWhere(sWhereString, "([AirlineName] like @lV7cAirlineName)");
         }
         else
         {
            GXv_int1[1] = 1;
         }
         if ( ! (0==AV8cAirlineDiscountPercentage) )
         {
            AddWhere(sWhereString, "([AirlineDiscountPercentage] >= @AV8cAirlineDiscountPercentage)");
         }
         else
         {
            GXv_int1[2] = 1;
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_H000I2(context, (string)dynConstraints[0] , (short)dynConstraints[1] , (string)dynConstraints[2] , (short)dynConstraints[3] , (short)dynConstraints[4] );
               case 1 :
                     return conditional_H000I3(context, (string)dynConstraints[0] , (short)dynConstraints[1] , (string)dynConstraints[2] , (short)dynConstraints[3] , (short)dynConstraints[4] );
         }
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("@lV7cAirlineName",GXType.NChar,50,0) ,
          new ParDef("@AV8cAirlineDiscountPercentage",GXType.Int16,3,0) ,
