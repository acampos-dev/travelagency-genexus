...
namespace GeneXus.Programs {
   public class gx0020 : GXDataArea
   {
      ...
      public void execute( out short aP0_pAttractionId )
      {
         ...
         ExecuteImpl();
         aP0_pAttractionId=this.AV9pAttractionId;
      }
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            {
               AV9pAttractionId = (short)(Math.Round(NumberUtil.Val( gxfirstwebparm, "."), 18, MidpointRounding.ToEven));
      ...
      protected void gxgrGrid1_refresh_invoke( )
      {
         ...
         gxgrGrid1_refresh( subGrid1_Rows, AV6cAttractionId, AV7cAttractionName, AV8cCountryId, AV11cCategoryId, AV12cCityId) ;
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("gx0020.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV9pAttractionId,4,0))}, new string[] {"pAttractionId"}) +"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "GXH_vCATTRACTIONNAME", StringUtil.RTrim( AV7cAttractionName));
      ...
      {
         return formatLink("gx0020.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV9pAttractionId,4,0))}, new string[] {"pAttractionId"})  ;
      }
      ...
      protected void WB040( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            GxWebStd.gx_single_line_edit( context, edtavCattractionname_Internalname, StringUtil.RTrim( AV7cAttractionName), StringUtil.RTrim( context.localUtil.Format( AV7cAttractionName, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,26);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavCattractionname_Jsonclick, 0, "Attribute", "", "", "", "", edtavCattractionname_Visible, edtavCattractionname_Enabled, 0, "text", "", 50, "chr", 1, "row", 50, 0, 0, 0, 0, -1, -1, true, "", "start", true, "", "HLP_Gx0020.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            ...
            GxWebStd.gx_single_line_edit( context, edtavCcountryid_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV8cCountryId), 4, 0, ".", "")), StringUtil.LTrim( ((edtavCcountryid_Enabled!=0) ? context.localUtil.Format( (decimal)(AV8cCountryId), "ZZZ9") : context.localUtil.Format( (decimal)(AV8cCountryId), "ZZZ9"))), " dir=\"ltr\" inputmode=\"numeric\" pattern=\"[0-9]*\""+TempTags+" onchange=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onblur(this,36);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavCcountryid_Jsonclick, 0, "Attribute", "", "", "", "", edtavCcountryid_Visible, edtavCcountryid_Enabled, 0, "text", "1", 4, "chr", 1, "row", 4, 0, 0, 0, 0, -1, 0, true, "", "end", false, "", "HLP_Gx0020.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
      ...
      protected void START042( )
      {
         ...
         Form.Meta.addItem("description", "Selection List Attractions", 0) ;
         context.wjLoc = "";
      ...
      protected void RF042( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            pr_default.dynParam(0, new Object[]{ new Object[]{
                                                 ...
                                                 AV6cAttractionId } ,
                                                 new int[]{
                                                 TypeConstants.SHORT, TypeConstants.SHORT, TypeConstants.SHORT, TypeConstants.SHORT, TypeConstants.SHORT, TypeConstants.BOOLEAN, TypeConstants.SHORT, TypeConstants.BOOLEAN, TypeConstants.SHORT
                                                 }
            });
            lV7cAttractionName = StringUtil.PadR( StringUtil.RTrim( AV7cAttractionName), 50, "%");
            /* Using cursor H00042 */
            pr_default.execute(0, new Object[] {AV6cAttractionId, lV7cAttractionName, AV8cCountryId, AV11cCategoryId, AV12cCityId, GXPagingFrom2, GXPagingTo2, GXPagingTo2});
            nGXsfl_64_idx = 1;
            sGXsfl_64_idx = StringUtil.PadL( StringUtil.LTrimStr( (decimal)(nGXsfl_64_idx), 4, 0), 4, "0");
            SubsflControlProps_642( ) ;
            while ( ( (pr_default.getStatus(0) != 101) ) && ( ( GRID1_nCurrentRecord < subGrid1_fnc_Recordsperpage( ) ) ) )
            {
               ...
               n11CategoryId = H00042_n11CategoryId[0];
      ...
      protected int subGrid1_fnc_Recordcount( )
      {
         ...
         lV7cAttractionName = StringUtil.PadR( StringUtil.RTrim( AV7cAttractionName), 50, "%");
         /* Using cursor H00043 */
         pr_default.execute(1, new Object[] {AV6cAttractionId, lV7cAttractionName, AV8cCountryId, AV11cCategoryId, AV12cCityId});
      ...
      protected void E17042( )
      {
         /* Start Routine */
         returnInSub = false;
         Form.Caption = StringUtil.Format( "Selection List %1", "Attractions", "", "", "", "", "", "", "", "");
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV9pAttractionId = Convert.ToInt16(getParm(obj,0));
         AssignAttri("", false, "AV9pAttractionId", StringUtil.LTrimStr( (decimal)(AV9pAttractionId), 4, 0));
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202612713434986", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("gx0020.js", "?202612713434987", false, true);
      ...
      protected void StartGridControl64( )
      {
         ...
         else
         {
            ...
            Grid1Container.AddColumnProperties(Grid1Column);
            Grid1Column = GXWebColumn.GetNew(isAjaxCallMode( ));
            Grid1Column.AddObjectProperty("Value", GXUtil.ValueEncode( StringUtil.RTrim( A8AttractionName)));
      ...
      public override void initialize_properties( )
      {
         ...
         divAttractionnamefiltercontainer_Class = "AdvancedContainerItem AdvancedContainerItemExpanded";
         ...
         Form.Caption = "Selection List Attractions";
         subGrid1_Rows = 10;
         if ( context.isSpaRequest( ) )
         {
            enableJsOutput();
      ...
      public override void initialize( )
      {
         ...
         H00042_n11CategoryId = new bool[] {false} ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.gx0020__default(),
            new Object[][] {
                new Object[] {
               H00042_A14CityId, H00042_n14CityId, H00042_A40000AttractionPhoto_GXI, H00042_A11CategoryId, H00042_n11CategoryId, H00042_A9CountryId, H00042_A8AttractionName, H00042_A7AttractionId, H00042_A13AttractionPhoto
               }
               , new Object[] {
      ...
      private bool[] H00042_n11CategoryId ;
   ...
   public class gx0020__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("@lV7cAttractionName",GXType.NChar,50,0) ,
