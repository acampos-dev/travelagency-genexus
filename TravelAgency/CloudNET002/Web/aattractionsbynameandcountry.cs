...
namespace GeneXus.Programs {
   public class aattractionsbynameandcountry : GXWebProcedure
   {
      ...
      public aattractionsbynameandcountry( )
      {
      ...
      public aattractionsbynameandcountry( IGxContext context )
      {
      ...
      protected override void ExecutePrivate( )
      {
         ...
         try
         {
            ...
            /* Using cursor P000W2 */
            pr_default.execute(0, new Object[] {AV9NameFrom, AV10NameTo, AV8CountryId});
            while ( (pr_default.getStatus(0) != 101) )
            {
               A9CountryId = P000W2_A9CountryId[0];
               A8AttractionName = P000W2_A8AttractionName[0];
               A40000AttractionPhoto_GXI = P000W2_A40000AttractionPhoto_GXI[0];
               A7AttractionId = P000W2_A7AttractionId[0];
               A10CountryName = P000W2_A10CountryName[0];
               A13AttractionPhoto = P000W2_A13AttractionPhoto[0];
               A10CountryName = P000W2_A10CountryName[0];
               H0W0( false, 100) ;
               getPrinter().GxAttris("Microsoft Sans Serif", 9, true, false, false, false, 0, 0, 0, 0, 0, 255, 255, 255) ;
      ...
      public override void initialize( )
      {
         ...
         P000W2_A40000AttractionPhoto_GXI = new string[] {""} ;
         P000W2_A7AttractionId = new short[1] ;
         P000W2_A10CountryName = new string[] {""} ;
         P000W2_A13AttractionPhoto = new string[] {""} ;
         A40000AttractionPhoto_GXI = "";
         A10CountryName = "";
         A13AttractionPhoto = "";
         sImgUrl = "";
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.aattractionsbynameandcountry__default(),
            new Object[][] {
                new Object[] {
               P000W2_A9CountryId, P000W2_A8AttractionName, P000W2_A40000AttractionPhoto_GXI, P000W2_A7AttractionId, P000W2_A10CountryName, P000W2_A13AttractionPhoto
               }
            }
         );
         /* GeneXus formulas. */
      ...
      private string[] P000W2_A40000AttractionPhoto_GXI ;
      private short[] P000W2_A7AttractionId ;
      private string[] P000W2_A10CountryName ;
      private string[] P000W2_A13AttractionPhoto ;
   }

   public class aattractionsbynameandcountry__default : DataStoreHelperBase, IDataStoreHelper
   {
                                             ...
                                             short A9CountryId )
      {
         ...
         scmdbuf = "SELECT T1.[CountryId], T1.[AttractionName], T1.[AttractionPhoto_GXI], T1.[AttractionId], T2.[CountryName], T1.[AttractionPhoto] FROM ([Attractions] T1 INNER JOIN [Country] T2 ON T2.[CountryId] = T1.[CountryId])";
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV9NameFrom)) )
         {
            AddWhere(sWhereString, "(T1.[AttractionName] >= @AV9NameFrom)");
         }
         else
         {
            GXv_int1[0] = 1;
